...
log_file_path1 = './FGT60E4Q16043370db.log20231219.json'
log_file_path2 = './FGT60E4Q16043370db.log20231220.json'
log_file_path3 = './FGT60E4Q16043370db.log20231221.json'
...
history = model.fit(train_data_reshaped, train_data_reshaped, epochs=nb_epochs, batch_size=batch_size,validation_split=0.1,callbacks=[tf.keras.callbacks.EarlyStopping(monitor='val_loss', patience=5, mode='min')], shuffle=False).history
